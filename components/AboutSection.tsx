const sections = [
  ...
  },
  {
    ...
    items: [
      "มองหาตำแหน่งฝึกงานที่เกี่ยวข้องกับ Software",
    ...
    <section id="about" className="bg-white dark:bg-black transition-colors duration-300">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-20">
        ...
        <p className="mt-4 text-gray-500 dark:text-gray-400 leading-relaxed">
          สวัสดีครับผมม่อน นายบุณยวัจน์ ชาญเวชศาสตร์ เป็นนักศึกษาสาขาวิศวกรรมซอฟต์แวร์ ชั้นปีที่ 3 มีประสบการณ์ในการพัฒนาเว็บแอปพลิเคชัน <br /> 
          การพัฒนา RESTful API และการจัดการฐานข้อมูลรวมถึงมีความสนใจในการประยุกต์ใช้ AI Agent ในการพัฒนาซอฟต์แวร์  <br /> 
          กำลังมองหาโอกาสในการฝึกงานเพื่อพัฒนาทักษะและสั่งสมประสบการณ์จากการทำงานจริงในสภาพแวดล้อมด้านซอฟต์แวร์
        </p>
